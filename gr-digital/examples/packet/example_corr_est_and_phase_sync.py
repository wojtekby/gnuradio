...
# Generated: Fri May 26 12:43:21 2017
##################################################
...
class example_corr_est_and_phase_sync(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Example Corr Est And Phase Sync")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Example Corr Est And Phase Sync")
        ...
        self.settings = Qt.QSettings("GNU Radio", "example_corr_est_and_phase_sync")
        ...
        self.tab1_grid_layout_1.addWidget(self._qtgui_const_sink_x_0_0_win,  0,0,1,1)
        ...
        self.tab1_grid_layout_1.addWidget(self._qtgui_const_sink_x_0_win,  0,1,1,1)
...
def main(top_block_cls=example_corr_est_and_phase_sync, options=None):
