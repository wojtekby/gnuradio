...
# Title: Example Corr Est
# Generated: Mon May 22 16:50:59 2017
##################################################
...
class example_corr_est(gr.top_block, Qt.QWidget):
...
def main(top_block_cls=example_corr_est, options=None):
