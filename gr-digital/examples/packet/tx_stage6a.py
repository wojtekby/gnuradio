...
# Title: Tx Stage6A
# Generated: Tue May 30 12:59:08 2017
##################################################
...
class tx_stage6a(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tx Stage6A")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tx Stage6A")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tx_stage6a")
    ...
    def set_rx_psf_taps(self, rx_psf_taps):
        ...
        self.fir_filter_xxx_0.set_taps((self.rx_psf_taps))
...
def main(top_block_cls=tx_stage6a, options=None):
